...
from cleanfunctions import address_clean, city_clean, baths_clean, lot_clean
...
def webscrape(zipcodes):
    ...
    for counter, zipcode in enumerate(zipcodes,1):
        ...
        lengths = [len_address, len_city, len_zip, len_beds, len_baths, len_lot, len_yearbuilt, len_garage, len_hometype, len_price]
        ...
        for counter, item in enumerate(lengths):
            if item[1] != len_proper:
                ...
                return address, city, zip_code, beds, baths, lot, yearbuilt, garage, hometype, price, address_raw, beds_raw, baths_raw, lot_raw, yearbuilt_raw, garage_raw, hometype_raw, price_raw
                sys.exit()
            else:
                pass

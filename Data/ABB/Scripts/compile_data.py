...
data_all_raw = pd.read_csv('.\Data\San_Francisco\listings 2.csv')
...
g = sns.pairplot(data_1, diag_kind = 'kde', kind = 'reg',
             ...
             x_vars = ['bedrooms', 'bathrooms', 'price', 'number_of_reviews', 'reviews_per_month'], 
             y_vars = ['bedrooms', 'bathrooms', 'price', 'number_of_reviews', 'reviews_per_month'])
g.map_lower(corrfunc)
g.savefig('.\Images\pairplot_2.jpg', dpi=600)
